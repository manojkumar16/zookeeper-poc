...
public class ClusterClient implements Watcher, Runnable {
	...
	public ClusterClient(String hostPort, Long pid) {
		...
		System.out.println("Adding member with process id "+processId);
		try {
...
//        }
       // String hostPort = args[0];
		...
		String hostPort = "zookeeper.zookeeper.iaas-data-poc.teipscpt.prod.walmart.com:2181";
        //Get the process id
